...
public class GridManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        character.transform.position = gridUnitList[35].transform.position - new Vector3(0, 0, 1);
    ...
    void GenerateMap()
    {
        ...
        for (int y = 0; y < mapY; y++) {
            ...
            {
                GridUnit unit = Instantiate(prefab_Grid, mapGroup);
    ...
    public void StartMovingMode()
    {
        ...
        inMovingMode = true;
        List<GridUnit> reachableGrids = CalculateReachableGrids(character.currentLocation, character.actionPoints);
    ...
    public List<GridUnit> CalculateReachableGrids(GridUnit startLocation, int actionPoint)
    {
        ...
        while (queue.Count > 0)
        {
            ...
            if (cost <= actionPoint)
            {
                ...
                foreach (GridUnit neighbor in GetNeighbor(gridUnit))
                {
    ...
    List<GridUnit> GetNeighbor(GridUnit gridUnit)
    {
    ...
    {
        CalculatePathfinding(character.currentLocation, targetLocation, character.actionPoints);
    }
    ...
    public void CalculatePathfinding(GridUnit startLocation, GridUnit targetLocation, int actionPoint)
    {
        ...
        while (openList.Count > 0)
        {
            ...
            foreach (GridUnit neighbor in GetNeighbor(currentNode.GridUnit))
            {
